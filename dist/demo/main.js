...
module.exports = "p {\n  font-family: Lato;\n}\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbImFwcC5jb21wb25lbnQuY3NzIl0sIm5hbWVzIjpbXSwibWFwcGluZ3MiOiJBQUFBO0VBQ0Usa0JBQWtCO0NBQ25CIiwiZmlsZSI6ImFwcC5jb21wb25lbnQuY3NzIiwic291cmNlc0NvbnRlbnQiOlsicCB7XG4gIGZvbnQtZmFtaWx5OiBMYXRvO1xufSJdfQ== */"
...
module.exports = "<div class=\"container\" class=\"padding\">\n\t<router-outlet></router-outlet>\n</div>"
...
/* harmony import */ var _datorama_akita_ngdevtools__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @datorama/akita-ngdevtools */ "./node_modules/@datorama/akita-ngdevtools/fesm5/datorama-akita-ngdevtools.js");
    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            imports: [
                ...
                _datorama_akita_ngdevtools__WEBPACK_IMPORTED_MODULE_5__["AkitaNgDevtools"].forRoot(),
...
/***/ "./src/app/core/filters/filter.model.ts":
/*!**********************************************!*\
  !*** ./src/app/core/filters/filter.model.ts ***!
  \**********************************************/
...
/***/ "./src/app/core/queries/todos.query.ts":
/*!*********************************************!*\
  !*** ./src/app/core/queries/todos.query.ts ***!
  \*********************************************/
...
/* harmony import */ var _filters_filter_model__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../filters/filter.model */ "./src/app/core/filters/filter.model.ts");
/* harmony import */ var rxjs_operators__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! rxjs/operators */ "./node_modules/rxjs/_esm5/operators/index.js");
/* harmony import */ var _store_todos_store__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../store/todos.store */ "./src/app/core/store/todos.store.ts");
...
var TodosQuery = /** @class */ (function (_super) {
    __extends(TodosQuery, _super);
    function TodosQuery(store) {
        var _this = _super.call(this, store) || this;
        _this.store = store;
        _this.selectVisibilityFilter$ = _this.select(function (state) { return state.ui.filter; });
        _this.selectVisibleTodos$ = Object(rxjs__WEBPACK_IMPORTED_MODULE_2__["combineLatest"])(_this.selectVisibilityFilter$, _this.selectAll(), _this.getVisibleTodos);
        _this.selectAllDone$ = _this.selectCount(function (todo) { return todo.completed; }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(function (count) {
            return _this.getCount() > 0 && count === _this.getCount();
        }));
        return _this;
    }
    TodosQuery.prototype.getVisibleTodos = function (filter, todos) {
        switch (filter) {
            case _filters_filter_model__WEBPACK_IMPORTED_MODULE_3__["VISIBILITY_FILTER"].SHOW_COMPLETED:
                return todos.filter(function (t) { return t.completed; });
            case _filters_filter_model__WEBPACK_IMPORTED_MODULE_3__["VISIBILITY_FILTER"].SHOW_ACTIVE:
                return todos.filter(function (t) { return !t.completed; });
            default:
                return todos;
        }
    };
    TodosQuery = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Injectable"])({
            providedIn: 'root'
        }),
        __metadata("design:paramtypes", [_store_todos_store__WEBPACK_IMPORTED_MODULE_5__["TodosStore"]])
    ], TodosQuery);
    return TodosQuery;
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _store_todos_store__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../store/todos.store */ "./src/app/core/store/todos.store.ts");
/* harmony import */ var _models_todo_model__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../models/todo.model */ "./src/app/core/models/todo.model.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var TodosService = /** @class */ (function () {
    ...
    TodosService.prototype.add = function (title) {
        var todo = Object(_models_todo_model__WEBPACK_IMPORTED_MODULE_2__["createTodo"])({ title: title });
        //Call backend and do below on success
    ...
    TodosService = __decorate([
        ...
        __metadata("design:paramtypes", [_store_todos_store__WEBPACK_IMPORTED_MODULE_1__["TodosStore"]])
    ], TodosService);
    return TodosService;
}());
...
/***/ "./src/app/core/store/todos.store.ts":
/*!*******************************************!*\
  !*** ./src/app/core/store/todos.store.ts ***!
  \*******************************************/
...
/* harmony import */ var _filters_filter_model__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../filters/filter.model */ "./src/app/core/filters/filter.model.ts");
var __extends = (undefined && undefined.__extends) || (function () {
    var extendStatics = function (d, b) {
        extendStatics = Object.setPrototypeOf ||
            ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
...
var initialState = {
    ui: { filter: _filters_filter_model__WEBPACK_IMPORTED_MODULE_2__["VISIBILITY_FILTER"].SHOW_ALL }
};
var TodosStore = /** @class */ (function (_super) {
    ...
    TodosStore = __decorate([
        ...
        Object(_datorama_akita__WEBPACK_IMPORTED_MODULE_0__["StoreConfig"])({ name: 'todos' }),
...
/***/ "./src/app/todos/filters/todos-filters.ts":
/*!************************************************!*\
  !*** ./src/app/todos/filters/todos-filters.ts ***!
  \************************************************/
...
/* harmony import */ var ngx_take_until_destroy__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ngx-take-until-destroy */ "./node_modules/ngx-take-until-destroy/dist/es5/index.js");
/* harmony import */ var ngx_take_until_destroy__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(ngx_take_until_destroy__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var src_app_core_filters_filter_model__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! src/app/core/filters/filter.model */ "./src/app/core/filters/filter.model.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var TodosFiltersComponent = /** @class */ (function () {
    function TodosFiltersComponent() {
        this.update = new _angular_core__WEBPACK_IMPORTED_MODULE_0__["EventEmitter"]();
    }
    TodosFiltersComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.control = new _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormControl"](this.active);
        this.control.valueChanges.pipe(Object(ngx_take_until_destroy__WEBPACK_IMPORTED_MODULE_2__["untilDestroyed"])(this)).subscribe(function (c) {
            _this.update.emit(c);
        });
    };
    TodosFiltersComponent.prototype.ngOnDestroy = function () { };
    __decorate([
    ...
    TodosFiltersComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
...
var TodoComponent = /** @class */ (function () {
    ...
    TodoComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.control = new _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormControl"](this.todo.completed);
        this.control.valueChanges.pipe(Object(ngx_take_until_destroy__WEBPACK_IMPORTED_MODULE_2__["untilDestroyed"])(this)).subscribe(function (completed) {
            _this.complete.emit(__assign({}, _this.todo, { completed: completed }));
        });
    };
...
/***/ "./src/app/todos/todos-page/todos-page.component.html":
/*!************************************************************!*\
  !*** ./src/app/todos/todos-page/todos-page.component.html ***!
  \************************************************************/
/*! no static exports found */
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var src_app_core_filters_filter_model__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! src/app/core/filters/filter.model */ "./src/app/core/filters/filter.model.ts");
/* harmony import */ var src_app_core_queries_todos_query__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! src/app/core/queries/todos.query */ "./src/app/core/queries/todos.query.ts");
/* harmony import */ var src_app_core_services_todos_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! src/app/core/services/todos.service */ "./src/app/core/services/todos.service.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var TodosPageComponent = /** @class */ (function () {
    function TodosPageComponent(todosQuery, todosService) {
        ...
        this.filters = src_app_core_filters_filter_model__WEBPACK_IMPORTED_MODULE_1__["initialFilters"];
    }
    ...
    TodosPageComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            ...
            template: __webpack_require__(/*! ./todos-page.component.html */ "./src/app/todos/todos-page/todos-page.component.html")
        }),
        __metadata("design:paramtypes", [src_app_core_queries_todos_query__WEBPACK_IMPORTED_MODULE_2__["TodosQuery"],
            src_app_core_services_todos_service__WEBPACK_IMPORTED_MODULE_3__["TodosService"]])
    ], TodosPageComponent);
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm5/router.js");
/* harmony import */ var _todos_todos_page_todos_page_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../todos/todos-page/todos-page.component */ "./src/app/todos/todos-page/todos-page.component.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var routes = [
    {
        path: 'todos',
        component: _todos_todos_page_todos_page_component__WEBPACK_IMPORTED_MODULE_2__["TodosPageComponent"]
    },
];
...
var TodosComponent = /** @class */ (function () {
    ...
    TodosComponent.prototype.trackByFn = function (index, todo) {
        return todo.id;
    };
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"])(),
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _angular_common__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/common */ "./node_modules/@angular/common/fesm5/common.js");
/* harmony import */ var _todo_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./todo.component */ "./src/app/todos/todo.component.ts");
...
/* harmony import */ var _todos_page_todos_page_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./todos-page/todos-page.component */ "./src/app/todos/todos-page/todos-page.component.ts");
...
/* harmony import */ var _filters_todos_filters__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./filters/todos-filters */ "./src/app/todos/filters/todos-filters.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var TodosModule = /** @class */ (function () {
    ...
    TodosModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            imports: [_angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_4__["ReactiveFormsModule"], _todos_routing_module__WEBPACK_IMPORTED_MODULE_6__["TodosRoutingModule"]],
            exports: [],
            declarations: [_todo_component__WEBPACK_IMPORTED_MODULE_2__["TodoComponent"], _todos_component__WEBPACK_IMPORTED_MODULE_3__["TodosComponent"], _todos_page_todos_page_component__WEBPACK_IMPORTED_MODULE_5__["TodosPageComponent"], _filters_todos_filters__WEBPACK_IMPORTED_MODULE_7__["TodosFiltersComponent"]]
        })
    ], TodosModule);
    return TodosModule;
}());
...
module.exports = __webpack_require__(/*! /home/other/akita-todos-app/src/main.ts */"./src/main.ts");
